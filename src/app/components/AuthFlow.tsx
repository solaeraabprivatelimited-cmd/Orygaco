  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      if (data.session?.access_token) {
        ...
        toast.success(data.isNewUser ? 'Account created successfully!' : 'Logged in successfully');
        ...
        if (userRole === 'patient') {
          ...
          console.warn('[AuthFlow] Unknown role:', userRole);
          toast.error(`Unknown user role: ${userRole}. Contact support.`);
          navigate('home');
        }
      } else {
